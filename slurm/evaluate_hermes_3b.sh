...
FLAGS=""
out_file="data/results_test/hermes-3b-"
...
python inference.py --model-provider llama --model-spec NousResearch/Hermes-3-Llama-3.2-3B-GGUF --out-path $out_file $FLAGS 